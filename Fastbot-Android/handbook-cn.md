...
工具git地址：https://github.com/bytedance/Fastbot_Android
## 优势：
1. Android多os兼容：
...
adb shell CLASSPATH=/sdcard/monkeyq.jar:/sdcard/framework.jar:/sdcard/fastbot-thirdpart.jar exec app_process /system/bin com.android.commands.monkey.Monkey -p com.example.androidcrash --agent reuseq --running-minutes 1 --throttle 1000 -v -v --bugreport D:\workspace\Fastbot_Android-main\pic --output-directory D:\workspace\Fastbot_Android-main\pic

其中的--bugreport、--output-directory 两个选项设置后并不能生效
